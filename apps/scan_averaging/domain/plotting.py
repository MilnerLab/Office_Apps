...
def plot_averaged_scan(ax: Axes, data: AveragedScansData, color: PlotColor = None, ecolor: PlotColor=None, label: str = "",marker = 'o',markersize=4) -> None:
    ...
    plot_ScanData(ax, data, label,color,ecolor,marker,markersize)