...
# Render animation:
#   manim -pqh animation_optical_centrifuge_woVMI.py PhysicalOpticalCentrifuge3D
#
...
class PhysicalOpticalCentrifuge3D(ThreeDScene):
    def construct(self) -> None:
        ...
        # manim -s -r 7680,4320 misc_scripts/animation_optical_centrifuge_woVMI.py PhysicalOpticalCentrifuge3D
        ...
        #1920, 1080
        # manim -p -r 3840,2160 --fps 60 misc_scripts/animation_optical_centrifuge_woVMI.py PhysicalOpticalCentrifuge3D
        # manim -pql misc_scripts/animation_optical_centrifuge_woVMI.py PhysicalOpticalCentrifuge3D
        ...
        self.add(pulse, detector_group, rotation_circle, molecule, lab_axes)
        self.add_fixed_orientation_mobjects(e_label, theta_label, *lab_axis_labels)
    ...
    def _make_lab_axes(
        ...
        y_axis = Line3D(start=origin, end=y_end - cone_height * y_dir, color=colors.coordinate_system, thickness=axis_thickness)
        z_axis = Line3D(start=origin, end=z_end - cone_height * z_dir, color=colors.cfg, thickness=axis_thickness)
        ...
        axes = VGroup(
            ...
            make_arrow_tip(y_end, y_dir, colors.coordinate_system, radius=cone_radius, height=cone_height),
            make_arrow_tip(z_end, z_dir, colors.cfg, radius=cone_radius, height=cone_height),
        )

        x_label = MathTex("x", font_size=40, color=colors.coordinate_system)
        y_label = MathTex("y", font_size=40, color=colors.coordinate_system)
        z_label = MathTex("z", font_size=40, color=colors.cfg)
