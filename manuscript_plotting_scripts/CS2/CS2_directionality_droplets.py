...
a = axs[0,0]
plot_averaged_scan(a, plottable_scan_1, PlotColor.BLUE,ecolor=PlotColor.RED,marker='d', label = "Accelerating")
...
a = axs[1,0]
plot_averaged_scan(a, plottable_scan_2, PlotColor.BLUE,ecolor=PlotColor.RED,marker='d',label="Decelerating")
a.grid(color='grey',linewidth=0.3)
a.legend()
a = axs[1,1]
