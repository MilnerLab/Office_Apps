...
a = axs[0,0]
plot_averaged_scan(a, plottable_scan_1, PlotColor.BLUE,ecolor=PlotColor.RED,marker='d', label = "OCS in 80 PSI Jet")
...
a = axs[1,0]
plot_averaged_scan(a, plottable_scan_2, PlotColor.BLUE,ecolor=PlotColor.RED,marker='d',label="NO-Dimer in 30 bar / 18 K Droplets")
a.grid(color='grey',linewidth=0.3)
a.legend()
a = axs[1,1]
